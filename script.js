 ...
 */
const pairNames = [
    ["맠맠", "맠런", "맠젠", "맠동", "맠잼", "맠천", "맠성"],
    ["런맠", "런런", "런젠", "런동", "런잼", "런천", "런성"],
    ["젠맠", "젠런", "젠젠", "젠동", "젠잼", "젠천", "젠성"],
    ["동맠", "동런", "동젠", "동동", "동잼", "동천", "동지"],
    ["잼맠", "잼런", "잼젠", "잼동", "잼잼", "잼천", "잼성"],
    ["천맠", "천런", "천젠", "천동", "천잼", "천천", "천지"],
    ["성맠", "성런", "성젠", "지동", "성잼", "지천", "성성"]
];
...
/* ==========================================
   ...
   드페스: 이 사이트(NCT DREAM). 칠페스: NCT127, 웨페스: NCT WayV, 잇페스: NCT WISH.
   체크박스 5개는 라디오처럼 한 번에 하나만 선택되고, 다른 유닛을 선택하면
   해당 그룹의 취향표 주소로 이동한다.
========================================== */

const CURRENT_UNIT = "deu";
